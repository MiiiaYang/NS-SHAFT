...
void App::Start() {
  ...
  // std::vector<std::string> bellImages;
  // bellImages.reserve(4);
  // bellImages.emplace_back(GA_RESOURCE_DIR"/Image/Character/ball-3.png");
  // bellImages.emplace_back(GA_RESOURCE_DIR"/Image/Character/ball-2.png");
  // bellImages.emplace_back(GA_RESOURCE_DIR"/Image/Character/ball-1.png");
  // bellImages.emplace_back(GA_RESOURCE_DIR"/Image/Character/ball-ok.png");

  // m_Ball = std::make_shared<AnimatedCharacter>(bellImages);
  // m_Ball->SetZIndex(5);
